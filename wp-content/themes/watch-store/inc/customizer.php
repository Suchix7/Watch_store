...
function watch_store_customize_register( $wp_customize ) {	
	...
	$wp_customize->add_setting('watch_store_width_options',array(
        'default' => 'Full Width',
        'sanitize_callback' => 'watch_store_sanitize_choices'
	));
	$wp_customize->add_control('watch_store_width_options',array(
        'type' => 'radio',
        'label' => __('Select Width Layout','watch-store'),
        'section' => 'watch_store_left_right',
        'choices' => array(
        	'Full Width' => esc_html__('Full Width','watch-store'),
            'Contained Width' => esc_html__('Contained Width','watch-store'),
            'Boxed Width' => esc_html__('Boxed Width','watch-store'),
        ),
	) );
	...
	$wp_customize->add_setting('watch_store_dropdown_anim',array(
		'default' => '',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'watch_store_sanitize_choices'
	));
	$wp_customize->add_control('watch_store_dropdown_anim', array(
		'section'  => 'watch_store_left_right',
		'label'    => __( 'Submenu Dropdown Effect','watch-store'),
		'type'     => 'select',
		'choices'  => array(
			'bounceInUp' => __('bounceInUp', 'watch-store'),
			'zoomIn' => __('zoomIn', 'watch-store'),
			'flip-up' => __('flip-up', 'watch-store'),
			'none' => __('none', 'watch-store')
		)
	));
	...
	$wp_customize->add_setting('watch_store_slider_animation',array(
		'default' => '',
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'watch_store_sanitize_choices'
	));
	$wp_customize->add_control('watch_store_slider_animation', array(
		'section'  => 'watch_store_slidersettings',
		'label'    => __( 'Onload Transaction Effect','watch-store'),
		'type'     => 'select',
		'choices'  => array(
			'bounceInLeft' => __('bounceInLeft', 'watch-store'),
			'bounceInRight' => __('bounceInRight', 'watch-store'),
			'bounceInUp' => __('bounceInUp', 'watch-store'),
			'bounceInDown' => __('bounceInDown', 'watch-store'),
			'zoomIn' => __('zoomIn', 'watch-store'),
			'zoomOut' => __('zoomOut', 'watch-store'),
			'fadeInLeft' => __('fadeInLeft', 'watch-store'),
			'fadeInRight' => __('fadeInRight', 'watch-store'),
			'fadeInUp' => __('fadeInUp', 'watch-store'),
			'fadeInDown' => __('fadeInDown', 'watch-store'),
			'flip-up' => __('flip-up', 'watch-store'),
			'none' => __('none', 'watch-store')
		)
	));
	...
	$wp_customize->add_setting('watch_store_slider_expert_length',array(
		'default'	=> '15',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control('watch_store_slider_expert_length',array(
		'label'	=> __('Slider Expert Length','watch-store'),
		'section' => 'watch_store_slidersettings',
		'type'	  => 'number'
	));

	$wp_customize->add_setting('watch_store_slider_title_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_slider_title_font_size',array(
		'label'	=> __('Title Font Size','watch-store'),
		'section' => 'watch_store_slidersettings',
		'type'	 => 'number'
	));

	$wp_customize->add_setting('watch_store_slider_text_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_slider_text_font_size',array(
		'label'	=> __('Text Font Size','watch-store'),
		'section' => 'watch_store_slidersettings',
		'type'	 => 'number'
	));

	$wp_customize->add_setting('watch_store_slider_btn_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_slider_btn_size',array(
		'label'	=> __('Button Size','watch-store'),
		'section' => 'watch_store_slidersettings',
		'type'	 => 'number'
	));
	...
	$wp_customize->add_setting( 'watch_store_slider_btnbg_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_slider_btnbg_color', array(
		'label' => __('Button Background Color', 'watch-store'),
		'section' => 'watch_store_slidersettings',
		'settings' => 'watch_store_slider_btnbg_color',
	)));
	...
	$wp_customize->add_setting( 'watch_store_slider_contbg_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_slider_contbg_color', array(
		'label' => __('Content Bg Color', 'watch-store'),
		'section' => 'watch_store_slidersettings',
		'settings' => 'watch_store_slider_contbg_color',
	)));
	...
	$wp_customize->add_setting('watch_store_bestseller_title_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_bestseller_title_font_size',array(
		'label'	=> __('Title Font Size','watch-store'),
		'section' => 'watch_store_bestseller_section',
		'type'	 => 'number'
	));

	$wp_customize->add_setting('watch_store_bestseller_section_text_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_bestseller_section_text_font_size',array(
		'label'	=> __('Text Font Size','watch-store'),
		'section' => 'watch_store_bestseller_section',
		'type'	 => 'number'
	));
	...
	$wp_customize->add_setting('watch_store_bestseller_product_title_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_bestseller_product_title_font_size',array(
		'label'	=> __('Product Title Font Size','watch-store'),
		'section' => 'watch_store_bestseller_section',
		'type'	 => 'number'
	));

	$wp_customize->add_setting('watch_store_bestseller_product_btn_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_bestseller_product_btn_font_size',array(
		'label'	=> __('Cart Button Font Size','watch-store'),
		'section' => 'watch_store_bestseller_section',
		'type'	 => 'number'
	));

	$wp_customize->add_setting( 'watch_store_bestseller_title_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_bestseller_title_color', array(
		'label' => __('Product Title Color', 'watch-store'),
		'section' => 'watch_store_bestseller_section',
		'settings' => 'watch_store_bestseller_title_color',
	)));

	$wp_customize->add_setting( 'watch_store_bestseller_price_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_bestseller_price_color', array(
		'label' => __('Price Color', 'watch-store'),
		'section' => 'watch_store_bestseller_section',
		'settings' => 'watch_store_bestseller_price_color',
	)));

	$wp_customize->add_setting( 'watch_store_bestseller_btn_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_bestseller_btn_color', array(
		'label' => __('Button Text Color', 'watch-store'),
		'section' => 'watch_store_bestseller_section',
		'settings' => 'watch_store_bestseller_btn_color',
	)));

	$wp_customize->add_setting( 'watch_store_bestseller_btnbg_color', array(
		'default' => '',
		'sanitize_callback'	=> 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'watch_store_bestseller_btnbg_color', array(
		'label' => __('Button Bg Color', 'watch-store'),
		'section' => 'watch_store_bestseller_section',
		'settings' => 'watch_store_bestseller_btnbg_color',
	)));
	...
	$wp_customize->add_setting('watch_store_footer_copy',array(
		'default'	=> 'Watch Store WordPress Theme',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	...
	$wp_customize->add_setting('watch_store_footer_copy_font_size',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_footer_copy_font_size',array(
		'label'	=> __('Font Size','watch-store'),
		'section' => 'watch_store_footer_section',
		'type'	 => 'number'
	));

	$wp_customize->add_setting('watch_store_footer_copy_padding',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('watch_store_footer_copy_padding',array(
		'label'	=> __('Top & Bottom Pading','watch-store'),
		'section' => 'watch_store_footer_section',
		'type'	 => 'number'
	));
	...
	// site logo size
	$wp_customize->add_setting('watch_store_logo_size',array(
		'default' => '',
		'sanitize_callback'	=> 'watch_store_sanitize_float'
	));
	$wp_customize->add_control('watch_store_logo_size',array(
		'type' => 'range',
		'label' => __('Logo Size','watch-store'),
