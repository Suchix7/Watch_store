...
function ecommerce_watch_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'ecommerce_watch_store_slidersettings' , array(
		...
		'description' => __('For more options of banner section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/watch-store-wordpress-theme">GET PRO</a>','ecommerce-watch-store'),
		'panel' => 'ecommerce_watch_store_panel_id'
	) );
	...
	$wp_customize->add_section( 'ecommerce_watch_store_product_setting' , array(
  	...
  	'description' => __('For more options of product section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/watch-store-wordpress-theme">GET PRO</a>','ecommerce-watch-store'),
		'priority'   => null,
		'panel' => 'ecommerce_watch_store_panel_id'
	) );
	...
	$wp_customize->add_section('ecommerce_watch_store_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/products/watch-store-wordpress-theme">GET PRO</a>','ecommerce-watch-store'),
		'panel' => 'ecommerce_watch_store_panel_id',
	));
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new Ecommerce_Watch_Store_Customize_Section_Pro( $manager,'ecommerce_watch_store_go_pro', array(
			...
			'pro_url'  => esc_url('https://www.vwthemes.com/products/watch-store-wordpress-theme'),
		) )	);
