...
* Added css for cart page and shop page add to cart button.
...
= 0.2.6 =
* Added featured, best selling, new arrivals, on sale text setting in customizer.
* Added css for product section tab.
* Updated pot file.
* Tested upto WP v6.6
...
* Resolved error for single product page.
* Added show /hide preloader for responsive setting.
* Added show /hide topbar for responsive setting.
* Added show /hide sidebar for responsive setting.
* Updated pot file.
...
= 0.3.1 =
* Added show /hide banner option in responsive media.
...
= 0.3.2 =
* Resolved css error for customizer.
* Resolved translation issue in custom-home-page.php file.
* Tested upto WP v6.7
