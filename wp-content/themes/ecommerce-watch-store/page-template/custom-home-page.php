                          ...
                          <div class="row">
                            <div class="col-lg-6 col-md-6 align-self-center py-2">
                              <div class="slider-price">
                                ...
                                <div class="plan-btn text-left py-3"><a class="pro-button" href="<?php the_permalink(); ?>">  <?php echo esc_html( __('SHOP NOW','ecommerce-watch-store'));?><span class="screen-reader-text"><?php echo esc_html('SHOP NOW','ecommerce-watch-store');?></span></a></div>
                              </div>
                            </div>
                            <div class="col-lg-6 col-md-6 align-self-center py-2">
